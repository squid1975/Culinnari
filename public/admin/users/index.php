        ...
        <section id="users">
            ...
            <table id="usersTable">
                ...
                <tr>
                    ...
                    <td class="adminTableUserFullName"><?php echo h($user->user_first_name); ?> <?php echo h($user->user_last_name); ?></td>
                    <td class="adminTableUserEmail"><?php echo h($user->user_email_address); ?></td>
                    <td class="adminTableUserJoinDate"><?php echo h(formatDate($user->user_create_account_date)); ?></td>
                    <td class="adminTableUserRole"><?php echo h($user->user_role); ?></td>
                    <td class="adminTableUserActive"> <?php echo $user->user_is_active == 1 ? 'yes' : 'no'; ?></td>
                    <td><a href="<?php echo url_for('/admin/users/show.php?id=' . h(u($user->id))); ?>">Manage</a></td>
                </tr>
                <?php } ?>
            </table>
        </section>
