                ...
                <?php if($diet_icons && $diet_icon_names): ?>
                    <?php foreach ($diet_icons as $index => $diet_icon): ?>
                        <img src="<?php echo url_for($diet_icon); ?>" 
                            alt="<?php echo h($diet_icon_names[$index]) . ' diet icon for ' . $recipe->recipe_name; ?>" width="20" height="20">
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
            ...
            <div class="starRating">
                ...
                if ($average_rating != 0): ?>
                    <div>
                        ...
                        $starRatingUniqueId = uniqid(); 
                        ?>
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                            <?php $clipPathId = 'star-clip-' . $starRatingUniqueId . '-' . $recipe->id . '-' . $i; ?>
                        <svg viewBox="0 0 24 24" class="star" width="24" height="24">
                            <defs>
                                <clipPath id="star-clip-<?php echo $clipPathId; ?>">
                            ...
                            <!-- Filled Star (clipped) -->
                            <path d="M12 2L14.9 8.6L22 9.3L16.5 14L18 21L12 17.5L6 21L7.5 14L2 9.3L9.1 8.6L12 2Z" 
                                fill="gold" clip-path="url(#<?php echo $clipPathId; ?>)"></path>
                        </svg>
                        <?php endfor; ?>
                    </div>
                <?php endif; ?>
