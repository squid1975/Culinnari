                    ...
                    <div class="filters">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <?php foreach ($mealTypes as $mealType): ?>
                                        <label>
                                            <input type="checkbox" name="mealTypes[]" id="mealType" value=<?php echo $mealType->id; ?>>
                        ...
                        <div class="searchFilter">
                            ...
                            <div class="dropdown">
                                <button type="button" class="dropdown-button">ANY</button> <!-- Button says ANY -->
                                <div class="dropdown-content">
                                    <label><input type="checkbox" name="prepCookTimeTotal[]" value=900> 15 mins or less</label> 
                                    <label><input type="checkbox" name="prepCookTimeTotal[]" value=1800> 30 mins or less</label> 
                                    <label><input type="checkbox" name="prepCookTimeTotal[]" value=2700> 45 mins or less</label> 
                                    <label><input type="checkbox" name="prepCookTimeTotal[]" value=3600-7200> 1-2 hours</label>
                                    <label><input type="checkbox" name="prepCookTimeTotal[]" value=7200+>2+ hours</label> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="searchFilter">
                            ...
                            <div class="dropdown">
                                <button type="button" class="dropdown-button">Default</button> 
                                <div class="dropdown-content">
                                    <label><input type="radio" name="sortBy" value="recipe[recipe_post_date] DESC" checked>Newest</label>
                                    <label><input type="radio" name="sortBy" value="recipe[recipe_post_date] ASC">Oldest</label>
                                    <label><input type="radio" name="sortBy" value="recipe[recipe_name] ASC">A-Z</label>
